...
wine = sqldf("select a.id, a.wood, a.fruits, a.tannin, b.age, b.country, b.region, b.variety, b.color, b.province, b.winery, b.title from wine_text a inner join wine_reviews b on (a.id = b.id)")
```
